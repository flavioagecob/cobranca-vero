import { Users, Search, CheckCircle2, CalendarClock } from 'lucide-react';
...
interface PreventiveQueueProps {
  ...
  onSelectCustomer: (customer: PreventiveQueueItem) => void;
  isLoading: boolean;
}
      ...
      <div className="p-3 border-b space-y-3">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="font-medium text-sm">Fila Preventiva</span>
          </div>
              ...
              >
                <div className="flex flex-col items-start w-full gap-1">
                  <div className="flex items-center justify-between w-full">
                    ...
                    <Badge 
                      variant="outline" 
                      className={cn("text-[10px] px-1 py-0", getDaysBadgeClass(item.dias_ate_vencer))}
                    >
                      {getDaysLabel(item.dias_ate_vencer)}
                    </Badge>
                  </div>
